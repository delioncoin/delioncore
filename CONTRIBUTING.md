Contributing to Delion Core
============================

The Delion Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Delion Core project, and is not to be
confused with overall Delion Network Protocol consensus changes.

Whether a pull request is merged into Delion Core rests with the project merge
...
Patches that change Delion consensus rules are considerably more involved than
...
Where a patch set proposes to change the Delion consensus, it must have been
...
The project leader is the release manager for each Delion Core release.
