...
In order to support loading of multiple wallets in delion-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is delion.cpp.
...
Changes to delion.cpp
----------------------
delion.cpp is the entry point into delion-qt, and as such, will require some minor modifications to provide hooks for
