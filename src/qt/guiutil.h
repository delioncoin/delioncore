...
/** Utility functions used by the Delion Qt UI.
 */
namespace GUIUtil
{
...
// Render Delion addresses in monospace font
...
// Parse "delion:" URI into recipient object, return true on successful parsing
